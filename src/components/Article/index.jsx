    ...
    return (
        <article className="my-90">
            <header className="text-center mb-40">
                <h3>
                    <Link to="/article/1">TheSaaS has just started!</Link>
                </h3>
            ...
            <Link to="/article/1">
                <img className="rounded" src={`${process.env.PUBLIC_URL}/assets/img/blog-6.jpg`} alt="..." />
            </Link>
      ...
      behold. Saying above moving second a subdue likeness after also second.</p>
                <p className="text-center mt-40">
                    <Link className="btn btn-primary btn-round" to="/article/1">Read more</Link>
                </p>
            </div>
        </article>
